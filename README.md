...
```sh
docker build -t comfyui-container:v1.6.5 <path to repo folder>
```
...
docker ps --all
```
to retrieve the name of the `comfyui-container:v1.6.5` container and rerun and interactively enter it with
```sh
